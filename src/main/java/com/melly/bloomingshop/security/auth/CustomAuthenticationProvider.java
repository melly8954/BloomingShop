...
import com.melly.bloomingshop.security.exception.AccountDeletedException;
import com.melly.bloomingshop.security.exception.CustomDisabledException;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) {
        ...
        User user = ((PrincipalDetails) userDetails).getUser();  // UserEntity 객체 가져오기
